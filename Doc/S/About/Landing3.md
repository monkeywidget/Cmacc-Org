r00t.Note=This page presents the key=value pairs, (aka properties) in the order that they are used in rendering.  Normally, they are presented in the order of most recent to oldest, as new is usually added at the top. But for a first-time reading, it is helpful to see how the page is built.  

r00t=<center>{Logo}<br><br><b>{Site.Name}</b></center></p><br>{Content.Sec}

Logo=<img src="image/cmacc-trans.png" style="width:35%" />

Site.Name=CommonAccord.Org

Content.Sec=<table><tr><td width="50%">{Intro.Sec}</td><td> </td><td valign="top"><br>CommonAccord is proud of its work with:<br><a href="http://WorldCC.com"><img src="image/logo-worldcc-hor-blue.svg" width="300" height="100"></a><br><a href="http://connection.mit.edu"><img src="Doc/S/About/Conference/Image/mit-connection-science.jpg" width="300" height="100"></a><br><img src="image/logo_cdc_small.svg" width="300" height="100"><img src="image/labchain.jpg" width="300" height="100"><br><br><a href="https://AssasLegalInnovation.com/"><img src="image/Favicon.png" width="200" height="150"><br>Assas Legal Innovation (Paris II)</a><br><br><b>Some Links:</b><br>Ask to join our Discord server <a href="mailto:commonaccord@gmail.com?Subject=Discord Invite" target="_top">email commonaccord@gmail.com.</a><br>{BlueSkyBlock.sec}<br><br><b><a href="https://github.com/CommonAccord/Cmacc-Org/commits/master">Latest Activity on GitHub</a></b><br><br>{DocumentsFolder.sec}<br>{SubjectIndex.Sec}<br>{RecentWork.Sec}</td></tr></table>
...
BlueSkyBlock.sec=<a  href="https://bsky.app/profile/commonaccord.bsky.social" width="600" height="300">BlueSky by @CommonAccord</a><script>
